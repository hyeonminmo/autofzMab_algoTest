    ...
    def focus_cpu_assign(self,  new_cpu_assign, focus_time: int) -> bool:
        ...
        for fuzzer in run_fuzzers:
            ...
            while focusRemainTime > 0 :
                ...
                logger.info(f'main 501 - focus round : {focusRound}end result - fuzzer : {fuzzer}, focusSuccess : {focusSuccess}, focusFail : {focusFail}, previousBitmap : {previousBitmap}, currentBitmap : {currentBitmap}, previousBug : {previousBug}, currentBug : {currentBug}, fuzzer success :  {self.tsFuzzers[fuzzer].S}, fuzzer fail : {self.tsFuzzers[fuzzer].F}, fuzzer threshold : {self.tsFuzzers[fuzzer].threshold}')
