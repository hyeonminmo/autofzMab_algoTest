...
logger =logging.getLogger('rcfuzz.fuzzer_driver')
...
class AFLBase(PSFuzzer):
    ...
    def gen_run_args(self):
        ...
        logger.info(f'fuzzer_driver 001 - AFLBASE class - args : {args} ')
        return args
...
class AFLPPBase(PSFuzzer):
    ...
    def gen_run_args(self):
        ...
        args += ['--', self.target]
        args += self.argument.split(' ')
        logger.info(f'fuzzer_driver 002 - AFLPPBASE class - args : {args} ')
        return args
...
class AFL(AFLBase):
    ...
    def gen_run_args(self):
        ...
        args += ['--', self.target]
        args += self.argument.split(' ')
        logger.info(f'fuzzer_driver 003 - AFL class - args : {args} ')
        return args
...
class AFLFAST(AFLBase):
    ...
    def gen_run_args(self):
        ...
        args += ['--', self.target]
        args += self.argument.split(' ')
        logger.info(f'fuzzer_driver 004 - AFLFAST class - args : {args} ')
        return args
...
class MOPT(AFLBase):
    ...
    def gen_run_args(self):
        ...
        args += ['--', self.target]
        args += self.argument.split(' ')
        logger.info(f'fuzzer_driver 005 - MOPT class - args : {args} ')
        return args
...
class FAIRFUZZ(AFLBase):
    ...
    def gen_run_args(self):
        ...
        args += ['--', self.target]
        args += self.argument.split(' ')
        logger.info(f'fuzzer_driver 006 - FAIRFUZZ class - args : {args} ')
        return args
...
class LEARNAFL(AFLBase):
    ...
    def gen_run_args(self):
        ...
        args += ['--', self.target]
        args += self.argument.split(' ')
        logger.info(f'fuzzer_driver 007 - LEARNAFL class - args : {args} ')
        return args
...
class LAFINTEL(AFLPPBase):
    ...
    def gen_run_args(self):
        ...
        args += ['--', self.target]
        args += self.argument.split(' ')
        logger.info(f'fuzzer_driver 008 - LAFINTEL class - args : {args} ')
        return args
...
class REDQUEEN(AFLPPBase):
    ...
    def gen_run_args(self):
        ...
        args += ['--', self.target]
        args += self.argument.split(' ')
        logger.info(f'fuzzer_driver 009 - REDQUEEN class - args : {args} ')
        return args
...
class RADAMSA(AFLPPBase):
    ...
    def gen_run_args(self):
        ...
        args += ['--', self.target]
        args += self.argument.split(' ')
        logger.info(f'fuzzer_driver 010 - RADAMSA class - args : {args} ')
        return args
