...
class Schedule_Autofz(Schedule_Base):
    ...
    def one_round(self):
        ...
        logger.info(f'main 029 - round {self.round_num} end - previous_bitmap: {previous_bitmap}, current_bitmap: {current_bitmap}, previous_unique_bug: {previous_unique_bug}, current_unique_bug: {current_unique_bug}')
